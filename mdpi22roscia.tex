...
\begin{figure}
	...
	\caption{\small The final design of the reaction wheel, shown together with its inertia principal axes. Here, $h$ is the wheel thickness, $r$ is the inner radius of the wheel and $R$ is the outer one. \MF{metti retino traslucido con inkscape sulla foto per vedere meglio r e R  }}
	\label{fig:flywheel}
\end{figure}
