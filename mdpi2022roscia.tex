...
\Author{Francesco Roscia $^{1}$, Andrea Cumerlotti $^{1, \, 2}$, Andrea Del Prete $^{3}$, Claudio Semini $^{1}$ and Michele Focchi$^{1, \, 2, ^*}$}
...
$^{2}$ \quad Department of Information Engineering and Computer Science (DISI), University of Trento, Trento, Italy\\
$^{3}$ \quad Industrial Engineering Department (DII), University of Trento, Trento, Italy\\
}
...
Most of quadruped robots are designed in such a way that the largest amount of the mass is located at the main body. As a consequence, the contribution of the moments due to the acceleration of other bodies is moderate. \\
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=.7\linewidth]{figures/fw_jump.eps}
